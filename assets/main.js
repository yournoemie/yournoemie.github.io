...
(function() {
	...
	// Container: container01.
		(function() {
			...
			new slideshowBackground('container01', {
				...
				images: [
					{
						src: 'assets/images/container01-98d3d99a.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/container01-746a1073.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/container01-eed367a0.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/container01-928ebb03.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/container01-5b9eb4a5.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-down', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-in', speed: 875, intensity: 5, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('#icons01', { style: 'zoom-in', speed: 750, intensity: 1, delay: 0, stagger: 125, state: true, replay: false });
		onvisible.add('#icons02', { style: 'zoom-in', speed: 750, intensity: 1, delay: 0, stagger: 125, state: true, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, stagger: 125, state: true, replay: false });
